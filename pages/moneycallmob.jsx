        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
          <div className="col-span-4">
            ...
            <p>
              ...
              was built has an attempt to turn mobile a previous project of
              mine: Money Call. This app lets you keep track of your daily
              expenditures and keep your budget in check for up to a year. All
              data is stored locally in a SQLite database. The app lets you{" "}

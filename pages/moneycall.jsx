      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <p>
            ...
            <span className="italic">React.js</span> website lets you keep track
            of your daily expenditures and keep your budget in check. Styled
            with <span className="italic">Material UI</span>, it lets you
            compare you expenses and incomes with beautiful charts provided by
            Google. All data is stored locally in your browser and, when
            you&apos;re done, you can even download it as a{" "}
